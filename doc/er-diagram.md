...
erDiagram
    ...
    RECORDS_AUDIT {
        ...
        string action_by
        int record_id
        string record_type_before
        string record_type_after
        string source_before
        string source_after
        ...
        string product_line_before
        string product_line_after
    }
    ...
    AUTHORS_AUDIT {
        ...
        string article_type_before
        string article_type_after
